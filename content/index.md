...
Aan de linker en rechterkant zien we een aantal [`Kernfuncties`](./kernfuncties/index.md) (paars): generieke functionaliteit die in de meeste applicaties voorkomt. Onderaan is voor de volledigheid het datagedreven werken (roze) getoond. De positionering hiervan laat zien dat alle binnen het domein van digitale dienstverlening gecreëerde en verwerkte gegevens gebruikt kunnen worden voor analyse, sturing en besluitvorming. Het [Gemeentelijk Gegevensmodel](https://www.gemeentelijkgegevensmodel.nl/) is de hiervoor te gebruiken standaard.
